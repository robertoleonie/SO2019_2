...
def opt(numQuadros):
    ...
    # obs: olha quanta verificacao e quanta etapa de laço sera feita! deve ser por isso que o algoritmo aumenta a complexidade quando possui entradas muito grandes
